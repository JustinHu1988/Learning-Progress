 ...
 */
// 本周目标设定
let weekScore = {math:100, economics:50, computer:320, physics:10, physicalExercise:24,
...
let dataArr=[
    {   year:2017,month:10,date:30,
        math:0, economics:0, computer:8, physics:0, physicalExercise:1,
        english:{hearing:4,reading:0,seeing:0,writing:0,grammar:0,speaking:0,word:0,value:0},
    },
];
